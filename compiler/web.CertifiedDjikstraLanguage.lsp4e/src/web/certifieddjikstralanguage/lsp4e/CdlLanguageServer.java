...
public class CdlLanguageServer implements StreamConnectionProvider {
	
	private final static boolean SOCKET_MODE = true;
	private StreamConnectionProvider delegate;

	public CdlLanguageServer() {
		if (SOCKET_MODE) {
			...
			URL resource = bundle.getResource("/language-server/dsl-language-server-jar");
			try {
